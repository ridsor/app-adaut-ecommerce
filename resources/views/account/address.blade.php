        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row gx-3 mb-3" style="row-gap: 1rem">
                    <div class="col-md-6">
                        <label class="small mb-1" for="recipient_name">Nama Penerima</label>
                        <input class="form-control @error('recipient_name') is-invalid @enderror" id="recipient_name"
...
@push('scripts')
    ...
    <script>
        const selectedDestination = @json($address?->address_label);
