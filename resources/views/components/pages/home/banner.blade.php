                                    ...
                                    <div class="d-flex h-100 align-items-center">
                                        <div class="p-lg-5 pb-5 p-2">
                                            ...
                                            @if ($banner->button_text)
                                                <a class="btn btn-outline-dark py-3 px-3 mt-4"
                        ...
                        <div class="row">
                            <div class="col-md-8 order-2 order-md-1">
                                <div class="d-flex h-100 align-items-center">
                                    <div class="p-lg-5 pb-5 p-2">
                                        ...
                                        <a class="btn btn-outline-dark py-3 px-3 mt-4" href="#daftar_produk">Mulai
                                            Belanja</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 pe-none order-1 order-md-2 justify-center">
                                <div class="d-flex h-100 w-100 align-items-center p-2 p-md-0">
                                    <img src="{{ asset('storage/gambar/produk/kain tenun anteng.png') }}" alt=""
