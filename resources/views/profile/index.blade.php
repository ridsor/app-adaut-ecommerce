    ...
    <div class="container-xl mt-4">
      <nav class="nav nav-borders">
        <a class="nav-link active ms-0"
          {{ !Request::routeIs("profile.index") ? `href="route('profile.index')` : "" }}>Profil</a>
        <a class="nav-link" {{ !Request::routeIs("profile.index") ? `href="route('profile.index')` : "" }}>Alamat</a>
      </nav>
      <hr class="mt-0 mb-4" />
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control @error("name") is-invalid @enderror" id="name" name="name"
                    type="text" placeholder="Masukkan nama Anda..." value="{{ old("name", $user->name) }}" />
                  <div class="invalid-feedback">
                    @error("name")
                      {{ $message }}
                    @enderror
