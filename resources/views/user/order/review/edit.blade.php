                ...
                <div class="d-flex gap-3 flex-column flex-md-row @error("rating") is-invalid @enderror"">
                  ...
                  <div class="rating">
                    <div x-data="{
                      ...
                      <input type="hidden" name="rating" x-ref="ratingInput" x-model="rating" value="0">
                        ...
                        <div class="d-flex mb-2">
                          <template x-for="(star, index) in ratings" :key="index">
                            <button type="button" @click="rate(star.amount)" @mouseover="hoverRating = star.amount"
                              ...
                              <img
                                :src="hoverRating >= star.amount || rating >= star
                  ...
                  <div class="d-flex gap-2 flex-wrap">
                    ...
                    <div x-show="imageFiles.length < maxImage">
                      <div class="border-1 text-gray-500 d-flex justify-content-center align-items-center"
                        style="width: 100px; height: 100px; border-style: dotted" @click="$refs.imageInput.click()"
                        @dragover.prevent="isDragging = true" @dragleave="isDragging = false"
                        @drop.prevent="handleImageDrop($event)">
                        <div class="d-flex flex-column align-items-center">
                          <span><span x-text="imageFiles.length">0</span>/<span x-text="maxImage">5</span></span>
                      ...
                      <input type="file" name="photos[]" hidden id="photos"
                        :disabled="imageFiles.length >= maxImage" accept=".jpg,.jpeg,.png,image/jpeg,image/png,image/webp"
                        x-ref="imageInput" @change="handleImageSelect" multiple
