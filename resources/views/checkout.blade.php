  ...
  <div class="container-xl py-4" x-data="checkout">
    ...
    <div class="card mb-4">
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <div class="order-body flex-grow-1 flex-column gap-1 d-flex ">
                      ...
                      <div class="d-flex gap-1 justify-content-between">
                        <div class="order-price fw-semibold" x-text="$store.globalState.formatPrice(item.price)">
                          Rp 0
                        </div>
      ...
      <div class="card-footer p-2 p-md-3">
        <input type="text" class="form-control" placeholder="Catatan untuk penjual (opsional)" x-model="data.note" />
      </div>
    </div>
    <div class="card mb-4">
      <div class="card-header">
      ...
      <div class="card-body overflow-auto">
        <div class="order-summary mt-3 d-flex flex-column gap-2">
          ...
          <div class="d-flex gap-1 justify-content-between flex-wrap">
            ...
            <span class="fw-semibold text-dark" x-text="$store.globalState.formatPrice(shipping.selected?.cost ?? 0)">
              Rp 0
            </span>
          </div>
          <div class="d-flex gap-1 justify-content-between flex-wrap">
      ...
      <div class="card-footer">
        <div class="d-flex justify-content-end">
          <button class="btn btn-primary"
            :disabled="Boolean(!shipping.selected | isSubmit | @json(!$user->address))" @click="handlePayment">
                ...
                <div class="d-flex flex-column">
                  <template x-for="(method, index) in shipping.methods" :key="index">
                    <div class="shipping-option d-flex justify-content-between align-items-center border p-2"
                      @click="shipping.select(method)" data-bs-dismiss="modal" style="cursor: pointer" role="link"
                      tabindex="0" aria-label="shipping-option" @keydown.enter="shipping.select(method)"
