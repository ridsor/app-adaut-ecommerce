          ...
          <div class="page-header-search mt-4">
            <form method="GET">
              <div class="input-group input-group-joined">
                <input class="form-control" type="text" name="search" placeholder="Cari..." aria-label="Cari"
                  autofocus="">
    ...
    <div class="container-xl px-4 list-item" x-data="{ itemId: null, deleteRoute: '' }">
      ...
      @if (count($categories) > 0)
        @foreach ($categories as $category)
          <div class="item card card-icon lift lift-sm mb-3 position-static overflow-hidden" style="cursor: pointer"
            role="link" tabindex="0" aria-label="category item">
            <div class="row g-0">
              <div class="col-auto card-icon-aside p-0" style="background: #f9f9f9">
                <img class="img-fluid ratio ratio-1x1 object-fit-contain p-2" src="{{ $category->icon }}"
              ...
              <div
                ...
                <a href="{{ route("category.edit", ["kategori" => $category->id]) }}" class="btn btn-warning btn-icon"
                  @click.stop>
