                          ...
                          <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionSearch"
                            ...
                            <div class="accordion-body">
                              ...
                              <div class="form-check">
                                <input class="form-check-input focus-shadow-none" type="radio" checked
                            ...
                            <div class="accordion-body">
                              <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Harga Minimun"
                                  name="min_price" value="{{ request()->query("min_price") }}" aria-label="Username"
                                  aria-describedby="basic-addon1" />
                              </div>
                              <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Rp</span>
                                <input type="text" class="form-control" placeholder="Harga Maksimum"
                                  name="max_price" value="{{ request()->query("max_price") }}" aria-label="Username"
                                  aria-describedby="basic-addon1" />
                              </div>
                            </div>
                          </div>
    ...
    <div class="container-xl px-4 list-item">
      ...
      @if (count($products) > 0)
        @foreach ($products as $product)
          <div x-data class="item card card-icon lift lift-sm mb-3 position-static overflow-hidden" style="cursor: pointer"
            role="link" tabindex="0" aria-label="product item"
              ...
              <div class="col-auto card-icon-aside p-0" style="background: #f9f9f9">
                <div class="position-relative">
                  <div x-show="@json(0 >= $product->stock)" x-transition>
                    <div
                      class="isEmpity top-0 start-0 end-0 bottom-0 z-2 d-flex justify-content-center align-items-center" style="position: absolute !important">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer"><button class="btn btn-danger" type="button"
                data-bs-dismiss="modal">Batal</button><button class="btn btn-success" type="submit">OK</button></div>
          </div>
        </div>
      </div>
    </form>
