            ...
            @if (count($products) > 0)
                @foreach ($products as $product)
                    <div class="item card card-icon lift lift-sm mb-3 position-static overflow-hidden"
                        ...
                        @click="window.location.href='{{ route('product.show', ['produk' => $product->id]) }}'"
                        @keydown.enter="window.location.href='{{ route('product.show', ['produk' => $product->id]) }}'"
                        @keydown.space.prevent="window.location.href='{{ route('product.show', ['produk' => $product->id]) }}'">
                        <div class="row g-0">
