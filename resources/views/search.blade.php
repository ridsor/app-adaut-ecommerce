    ...
    <main x-data>
        <section>
            <div class="container mt-4">
                <h1 class="h2 fw-bold mb-4">Pencarian</h1>
                <div class="row">
                        ...
                        <div class="ps-xl-6">
                            <div class="search-header row g-2 g-xl-4 mb-4 flex-wrap">
                                <div class="col-12 col-lg-6">
                                    <form method="GET">
                                        <div class="rounded position-relative">
                                            <input class="form-control bg-light pe-5 ps-3 py-2" type="search"
                                ...
                                <div class="col-12 col-md-6 col-lg-3 ms-auto">
                                    <select class="form-select py-2" name="sort" aria-label="sort"
                                        @change="sorftBy($event)">
                                ...
                                <div class="row px-3 px-md-0 g-4">
                                    ...
                                    @else
                                        <div class="text-center mt-4">
                                            ...
                                            <p class="lead">Oops, {{ request()->query('value') ?? 'produk' }} tidak
                                                ditemukan.</p>
