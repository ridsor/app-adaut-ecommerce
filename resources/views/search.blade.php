...
<main x-data>
        <div class="container py-5">
            ...
            <div class="row">
                <div class="right col-3 d-none d-xl-block">
                            ...
                            <div class="accordion accordion-alt" id="accordionExample">
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input focus-shadow-none" type="radio"
                                                    checked
                                                    name="availability" id="availability1" value="all">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label heading-color" for='category{{ $category->id }}'>{{ $category->name }}</label>
                                ...
                                <div class="accordion-body">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Harga Minimun" name="min_price" value="{{ request()->query('min_price') }}"
                                        aria-label="Username" aria-describedby="basic-addon1">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">Rp</span>
                                                <input type="text" class="form-control" placeholder="Harga Maksimum" name="max_price" value="{{ request()->query('max_price') }}"
                                                aria-label="Username" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-body">
                                    <ul class="list-inline mb-0 g-3">
                                        ...
                                        <li class="list-inline-item mb-0">
                                            ...
                                            name="rating[]" value='{{ $i }}' class="btn-check" id="btn-check-{{ $i }}">
                                            <label class="btn btn-sm btn-light btn-primary-soft-check"
                                            for="btn-check-{{ $i }}">{{ $i }}<i class="bi bi-star-fill"></i></label>
                                        </li>
                                        @endfor
                                    </ul>
                                </div>
                    ...
                    <div class="d-flex justify-content-between p-2 p-xl-0 mt-xl-3 align-items-center">
                        <a class="btn btn-link text-primary-hover p-0 mb-0 text-decoration-none" href="{{ route('search') }}?{{ http_build_query(['value' => request()->query('value')]) }}">Hapus Semua</a>
                            ...
                            <div class="col-12 col-lg-6">
                                <form method="GET">
                                    <div class="rounded position-relative">
                                        <input class="form-control bg-light pe-5 ps-3 py-2" type="search" name="value" value="{{ request()->query('value') }}"
                        ...
                        <div class="search-list">
                            <div class="row px-3 px-md-0 g-4">
                                ...
                                <div class="text-center mt-4">
                                    <img class="img-fluid p-4" src="/assets/img/illustrations/404-error.svg" alt="" style="max-width: 400px" />
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <form class="accordion-body">
                                ...
                                <div class="color-check-radio">
                                    <input class="form-check-input" type="radio" name="flexRadiocolor"
                                        id="flexRadiocolor1" style="background-color: #9a0a0a;">
                                    <label class="form-check-label" for="flexRadiocolor1"></label>

                                    <input class="form-check-input" type="radio" name="flexRadiocolor"
                                        id="flexRadiocolor2" style="background-color: #32C7F5;">
                                    <label class="form-check-label" for="flexRadiocolor2"></label>

                                    <input class="form-check-input" type="radio" name="flexRadiocolor"
                                        id="flexRadiocolor3" style="background-color: #F7C32E;">
                                    <label class="form-check-label" for="flexRadiocolor3"></label>

                                    <input class="form-check-input" type="radio" name="flexRadiocolor"
                                        id="flexRadiocolor4" style="background-color: #333369;">
                            ...
                            <form class="accordion-body">
                                <ul class="list-inline mb-0 g-3">
                                    ...
                                    <li class="list-inline-item mb-0">
                                        ...
                                        <label class="btn btn-sm btn-light btn-primary-soft-check" for="btn-check-15">4<i
                                                class="bi bi-star-fill"></i></label>
                                    </li>
                                    <!-- Item -->
                                    <li class="list-inline-item mb-0">
                                        <input type="checkbox" class="btn-check" id="btn-check-16">
                                        <label class="btn btn-sm btn-light btn-primary-soft-check" for="btn-check-16">5<i
                                                class="bi bi-star-fill"></i></label>
                                    </li>
                                </ul>
                            </form>
